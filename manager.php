...
<body>
                        ...
                        <div class="row p-2 m-auto hideBlock">
                            <div class="col">
                                <fieldset class="border border-light col h-100">
                                    ...
                                    <h5><span class="p-1" id="viewDesc">

                                        </span></h5>
                                </fieldset>

                            </div>
                            <div id="workersDiv" class="col"></div>
            ...
            <div class="container-fluid">
                <div class="main-body">
                    ...
                    if ($role == 'MANAGER') :
                        ...
                        // Query to get total complaints
                        $totalComplaintsQuery = "SELECT COUNT(*) as total FROM complaints WHERE status IN (1,2,3,4,5,6)";
                        ...
                        // Query to get pending complaints with status 2,3
                        $pendingComplaintsQuery = "SELECT COUNT(*) as pending FROM complaints WHERE status IN(1,2,3,4)";
                        ...
                        // Query to get completed complaints with status 3,4
                        $completedComplaintsQuery = "SELECT COUNT(*) as completed FROM complaints WHERE status IN (5,6)";
                        ...
                        // Query to get itkm pending complaints with status 1
                        $itkmpendingComplaintsQuery = "SELECT COUNT(*) as pending FROM complaints WHERE status IN(1,3)";
                        ...
                        // Query to get itkm completed complaints with status 3
                        ...
                        // Query to get general pending complaints with status 2
                        $genpendingComplaintsQuery = "SELECT COUNT(*) as pending FROM complaints WHERE status IN(2,4)";
                        ...
                        // Query to get general completed complaints with status 4
                        $gencompletedComplaintsQuery = "SELECT COUNT(*) as completed FROM complaints WHERE status = 6";
                        ...
                        $itkm5dquery = mysqli_query($db, "SELECT COUNT(*) as completed FROM complaints WHERE status = 5 AND DATE(fin_date) >= CURDATE() - INTERVAL 7 DAY");
                        $itkm5d = mysqli_fetch_assoc($itkm5dquery)['completed'];
                        $gen5dquery = mysqli_query($db, "SELECT COUNT(*) as completed FROM complaints WHERE status = 6 AND DATE(fin_date) >= CURDATE() - INTERVAL 7 DAY");
                        ...
                        <div class="card text-light">
                            <div class="card-body pb-0">
                                <div class="row d-flex align-items-stretch">
                                    <div class="m-auto col-sm-6 col-md-6 col-lg-3 col-xl-3 h-100" id="a1">
                                        <div class="card card-hover">
                                            <div class="box bg-cyan text-center">
                                                <h1 class="font-light text-white"><i class="mdi mdi-wallet-travel"></i></h1>
                                                <h4 class="text-white text-truncate"><b>Total Complaints</b></h4>
                                                <h4 class="text-white text-truncate"><b><?php echo $totalComplaintsCount; ?> </b></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="m-auto col-sm-6 col-md-6 col-lg-3 col-xl-3 h-100" id="a2">
                                        <div class="card card-hover">
                                            <div class="box bg-warning text-center">
                                                <h1 class="font-light text-white"><i class="mdi mdi-worker"></i></h1>
                                                <h4 class="text-white text-truncate"><b>Pending</b></h4>
                                                <h4 class="text-white text-truncate"><b><?php echo $pendingComplaintsCount; ?></b></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="m-auto col-sm-6 col-md-6 col-lg-3 col-xl-3 h-100" id="a3">
                                        <div class="card card-hover">
                                            <div class="box bg-success text-center">
                                                <h1 class="font-light text-white"><i class="mdi  mdi-check-circle-outline"></i></h1>
                                                <h4 class="text-white text-truncate"><b>Finished</b></h4>
                                                <h4 class="text-white text-truncate"><b><?php echo $completedComplaintsCount; ?></b></h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row card-body pt-0">
                                <div class=" card-hover col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
                                    <div class="shadow-sm border border-secondary rounded">
                                        <div class="p-2 bg-secondary text-center">
                                            <h4 class="text-white"><b>ITKM [Past 7 days: <?= $itkm5d ?>]</b></h4>
                                        </div>
                                        <div class="row pl-3 pt-3 pr-3">
                                            <!-- First Nested Card -->
                                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" id="a4">
                                                <div class="card card-hover">
                                ...
                                <div class=" card-hover col-sm-12 col-md-12 col-lg-6 col-xl-6 my-2">
                                    <div class="shadow-sm  border border-secondary rounded">
                                        <div class="p-2 bg-secondary text-center">
                                            <h4 class="text-white"><b>General Complaints [Past 7 days: <?= $gen5d ?>]</b></h4>
                                        </div>
                                        <div class="row pl-3 pt-3 pr-3">
                                            <!-- First Nested Card -->
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="myTable1" class="table table-hover table-bordered text-center" style="display: table;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    if ($role == 'MANAGER') {
                                        $query = "SELECT * FROM complaints where status IN (1,2,3,4,5,6) ORDER BY id DESC";
                                        echo "<script>console.log('log - manager')</script>";
                                    } elseif ($role == 'FACULTY') {
                                        $query = "SELECT * FROM complaints WHERE fac_id='$s' ORDER BY id DESC";
                                        echo "<script>console.log('log - faculty')</script>";
                                    } else {
                                        $query = "SELECT * FROM complaints  ORDER BY id DESC ";
                                        echo "<script>console.log('log - others')</script>";
                                    }
                                        ...
                                        foreach ($query_run as $complaints) {
                                            ...
                                            switch ($v) {
                                                ...
                                                case 2:
                                                    ...
                                                    break;
                                                case 3:
                                                    $statusMessage = 'Assigned to Workers';
                                                    break;
                                                case 4:
                                                    $statusMessage = 'Assigned to Workers';
                                                    break;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <?php
                                                        echo '<script>console.log(' . $complaints['status'] . ')</script>';
                                                        if (($complaints['status'] == 1 || $complaints['status'] == 2)  && $role == 'FACULTY') { ?>
                            ...
                            <table id="myTable2" class="table table-hover table-bordered text-center" style="display: none;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    $query = "SELECT * FROM complaints where status IN (1,2,3,4) ORDER BY id DESC";
                            ...
                            <table id="myTable3" class="table table-hover table-bordered text-center" style="display: none;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    $query = "SELECT * FROM complaints WHERE status IN(5,6) ORDER BY id DESC ";
                            ...
                            <table id="myTable5" class="table table-hover table-bordered text-center" style="display: none;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    $query = "SELECT * FROM complaints  WHERE status IN (1,3)  ORDER BY id DESC";
                            ...
                            <table id="myTable6" class="table table-hover table-bordered text-center" style="display: none;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    $query = "SELECT * FROM complaints  WHERE status = 6 ORDER BY id DESC";
                            ...
                            <table id="myTable7" class="table table-hover table-bordered text-center" style="display: none;">
                                ...
                                <tbody id="table-body">
                                    ...
                                    $query = "SELECT * FROM complaints  WHERE status IN(2,4) ORDER BY id DESC";
                                    // echo "<script>console.log('MANAGER')</script>";
    ...
    <script>
        ...
        function toggleTable(tableName) {
            ...
            var table3 = document.getElementById('myTable2');
            var table4 = document.getElementById('myTable3');
            var table5 = document.getElementById('myTable4');
            var table6 = document.getElementById('myTable5');
            var table7 = document.getElementById('myTable6');
            var table8 = document.getElementById('myTable7');
